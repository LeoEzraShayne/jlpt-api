...
The owner approved one global USD price set: DAY_PASS $0.99 / 24 hours; YEAR_PASS $64 / 365 days for the first six UTC calendar months from the original Web charging activation (clamp to the last day when the target month is shorter), then $99 / 365 days. Prices are one-time, not recurring. The owner expressly accepted Google Play automatic conversion to local buyer currencies, including JPY in Japan. The offer applies in all supported regions. The original launch is `2026-09-12T23:58:15.676Z`, with exclusive cutoff `2027-03-12T23:58:15.676Z`; the 365-day gift and saved historical quote/order snapshots remain unchanged. There is no independent Japanese discount or fixed JPY price. Web Stripe uses USD. Buying currency, merchant payout currency and accounting currency are different concepts.
