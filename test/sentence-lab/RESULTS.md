...
## 2026-09-13 F final bounded mixed-candidate round

Parent lease fix 0bf99ed, D grammar-only thinking candidate 1acb110+3e71d71, environment467741a and card quotes dae88f4 independently integrated. **49/49 tests across ten suites passed**, including the original crash-budget reproducer, concurrent manual recovery/terminal quota release, overlapping old/new lease persistence and card-only versus legacy-quote idempotent retry. Scoped typing now includes the nested F synthetic scripts as well as suites.

Actual mixed route: 24 frozen held-out operations, 27 network calls/receipts, 3 charged first-response rejections repaired in the second slot. All 24 final core semantic/structural checks passed; one diagnostic wording advisory remains documented. Paid estimate $0.011798346, all usage complete, thinking counted once. See `ai-audit/route-held-out/MIXED-REVIEW.md` and independently executable audit. The report compares current and historical costs, including 100% grammar and free-user allocation; favorable small-sample daily means do not eliminate loss scenarios. No production/default/price/billing changes or unlimited-profit/JLPT-wide claims were made.
