...
result_level仅为CORRECT、MOSTLY_CORRECT、NEEDS_REVISION、INCORRECT。error_spans逐处列出所有真实错误，不省略需要调整的地方；每项text为原句错误片段，replacement为具体修改，reason用简体中文解释原因，另有start/end原句字符位置。原句正确时为空数组，不捏造问题。
